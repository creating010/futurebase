	...
	Template.registerLogin.events({
		...
		'click .form1 .advance': function(event){
			...
			if (firstnameVar != '' && surnameVar != '' && emailVar != '' && passwordVar != '' && classVar != null && tokenVar != '') {
				...
				Notifications.error('FutureBase', 'Please, fill in all fields.');
			}
		},
...
Menu.prototype =
{
	...
	setEvents: function()
	{
		...
		// var page_node		= this.menu_node.parents('body:first');
